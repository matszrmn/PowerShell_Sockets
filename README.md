...
<br />
## Comandos (Cliente)
- __testnotepad__ <p>&nbsp;&nbsp;&nbsp; Abre 10 páginas do notepad com a frase "Testando notepad !!!"</p>
- __setvolume__ <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Modifica o volume do servidor, exemplo: __setvolume 20__ deixa o volume do servidor em 20</p>
